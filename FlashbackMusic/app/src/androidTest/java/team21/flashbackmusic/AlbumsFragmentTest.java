...
public class AlbumsFragmentTest {
    ...
    public void updateSongUITest() {
        ...
        for (Fragment fragment:fragments) {
            if(fragment.getTag().compareTo("albums") ==1) {
                AlbumsFragment afragment = (AlbumsFragment)fragment;
                ...
                TextView songName = (TextView) afragment.getActivity().findViewById(R.id.big_song_name);
                TextView artistAlbumInfo = (TextView) afragment.getActivity().findViewById(R.id.big_song_artist);
                TextView songTime = (TextView) afragment.getActivity().findViewById(R.id.big_song_time);
