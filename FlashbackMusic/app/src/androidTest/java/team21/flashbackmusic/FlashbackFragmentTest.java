...
public class FlashbackFragmentTest {
    ...
    public void updateSongUITest() {
        ...
        for (Fragment fragment:fragments) {
            if(fragment.getTag().compareTo("flashsongs") ==1) {
                FlashbackFragment ffragment = (FlashbackFragment)fragment;
                ...
                ffragment.updateSongUI(testSong1);
                TextView songName = (TextView) ffragment.getActivity().findViewById(R.id.big_song_name);
                TextView artistAlbumInfo = (TextView) ffragment.getActivity().findViewById(R.id.big_song_artist);
                TextView songTime = (TextView) ffragment.getActivity().findViewById(R.id.big_song_time);
